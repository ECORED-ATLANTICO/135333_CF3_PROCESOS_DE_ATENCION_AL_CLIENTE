    ...
    div.slider-wrapper.z-2.mb-6
      ...
      .tarjeta.tarjeta--blanca.position-relative.p-4.pt-5.z-2.my-5
        SlyderA(tipo="b")
          ...
          .row.z-2.justify-content-center.align-items-center
            .col-lg-5
              p.mb-4.mb-lg-0 Desde la perspectiva social, las empresas para poder operar requieren contar con personal, y es así como acuden a personas con diferentes perfiles para que realicen las actividades necesarias para su funcionamiento. 
            .col-lg-6
              figure
          ...
          .row.z-2.justify-content-center.align-items-center
            .col-lg-6
              ...
              p.mb-4.mb-lg-0 #[strong Visión:] en el año 2022 el SENA se consolidará como una entidad referente de formación integral para el trabajo, por su aporte a la empleabilidad, el emprendimiento y la equidad, que atiende con pertinencia y calidad las necesidades productivas y sociales del país.
            .col-6.col-lg-5
              figure
          ...
          .tarjeta.bg-primario-claro.p-4(titulo="Estructura horizontal")
            .row.align-items-center.p-4
              .col-12.col-lg-8
                ...
                p.mb-4.mb-lg-0 #[strong Desventaja]: puede ser complejo llegar a consensos. 
              .col-12.col-lg-4.align-items-center.mb-3.mb-lg-0
                figure.justify-center
                  img.img-180(src='@/assets/curso/tema1/8.svg', alt='')
          .tarjeta.bg-primario-claro.p-4(titulo="Estructura vertical")
            .row.align-items-center.p-4
              .col-12.col-lg-8
                ...
                p.mb-4.mb-lg-0 #[strong Desventaja]: el proceso para la toma de decisiones es lento. Puede ocurrir cambio de estrategia cuando cambian los directivos. 
              .col-12.col-lg-3.align-items-center.mb-3.mb-lg-0
                figure.justify-center
                  img.img-120(src='@/assets/curso/tema1/15.svg', alt='')
          .tarjeta.bg-primario-claro.p-4(titulo="Estructura circular")
            .row.align-items-center.p-4
              .col-12.col-lg-8
                ...
                p.mb-4.mb-lg-0 #[strong Desventaja]: es difícil visualizar cuál es el esquema de mando.
              .col-12.col-lg-4.align-items-center.mb-3.mb-lg-0
                figure.justify-center
                  img.img-180(src='@/assets/curso/tema1/16.svg', alt='')
